...
import { initModifyValueRows } from "./action_modify_value_row_postgre.js";
...
export function displayColumnTypeDataList() {
  ...
  try {
    ...
    // Initialiser les actions des boutons après construction du tableau
    initModifyValueRows();
    ...
    // ici tu peux arrêter ton spinner
    stopSpinner();
